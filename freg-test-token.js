...
var cert = fs.readFileSync('privateKey-test.pem');  // get private key
var cert_pub = fs.readFileSync('publicKey-test.pem');

// Start timer
console.time('Token request')

// Create JWT signed token test signature certificate
var headerOptions = {
